...
- Phaser 3 렌더러
- Colyseus 권위 게임 서버와 protocol v8
...
- 공식 편집 맵 119방, 세 구역, seed별 9개 게이트와 최종 보스
- 솔로 서버 AI, 재접속·이탈 인계, 개인 증강·장비 인벤토리, 파티 미니맵
- 상점·신전·함정·체크포인트·도박·제단·골드 특수 방

현재 알려진 주요 제한은 온라인 Space 대시 입력 매핑 결함, 프로덕션 연결 실패의 로컬 폴백, 서버 건설 미구현이다. 정확한 구현 범위와 완료 기준은 [제품·게임플레이 명세](./Document/01-product-gameplay-spec.md)를 따른다.
